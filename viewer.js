...
document.addEventListener("DOMContentLoaded", () => {
  const start = async () => {
    const mindarThree = new window.MINDAR.IMAGE.MindARThree({
      ...
      imageTargetSrc: './assets/targets/black_bucket_hat.mind',
    });
    ...
    const gltf = await loadGLTF('./assets/models/black_bucket_hat.glb');
    ...
    const audioClip = await loadAudio('./assets/sounds/black_bucket_hat.mp3');
